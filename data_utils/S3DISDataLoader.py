...
if __name__ == '__main__':
    data_root = '/data2/yxu/PointNonLocal/data2/stanford_indoor3d/'
    ...
    print('point data2 size:', point_data.__len__())
    print('point data2 0 shape:', point_data.__getitem__(0)[0].shape)
