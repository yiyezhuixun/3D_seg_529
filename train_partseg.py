...
# seg_classes = {'car': [0, 1,2]}

seg_classes = {'book': [0,1,2]}
...
def parse_args():
    ...
    parser.add_argument('--npoint', type=int, default=4096*10, help='point Number')
...
def main(args):
    ...
    log_string("The number of training data2 is: %d" % len(TRAIN_DATASET))
    log_string("The number of test data2 is: %d" % len(TEST_DATASET))
